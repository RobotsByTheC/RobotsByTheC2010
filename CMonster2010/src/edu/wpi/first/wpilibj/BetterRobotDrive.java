...
public class BetterRobotDrive {
     ...
     * @param sensitivity Effectively sets the turning sensitivity (or turn radius for a given value)
     */
    public BetterRobotDrive(final int frontLeftMotor, final int rearLeftMotor,
            final int frontRightMotor, final int rearRightMotor, double sensitivity) {
        m_sensitivity = sensitivity;
     ...
     * @param sensitivity Effectively sets the turning sensitivity (or turn radius for a given value)
     */
    public BetterRobotDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
